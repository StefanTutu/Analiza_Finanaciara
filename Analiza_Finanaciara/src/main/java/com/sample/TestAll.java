...
public class TestAll {
	...
	public static void main(String[] args) {
		...
		IndicatorFinanciar test = new IndicatorFinanciar(1003L, "Autonomie Financiara si Solvabilitate si Viteza de rotatie a activelor",
				...
				conturiCifraDeAfaceri, conturiCapitaluriCirculante, conturiStocGlobalMediu
				);
